...
use App\Models\subscriptionpackage_demo;
use Illuminate\Console\Command;
use Srmklive\PayPal\Services\PayPal as PayPalClient;

class ForDemo extends Command
{
    ...
    public function handle()
    {
        ...
        $plans = subscriptionpackage_demo::all();
        ...
        foreach ($plans as $plan) {
            ...
            $payload = [
                ...
                'name' => $plan->plan_name,
                'description' => "{$plan->plan_name} Subscription - {$plan->plan_duration} minute",
                'status' => 'ACTIVE',
                'billing_cycles' => [
                    [
                        'frequency' => [
    ...
    protected function createProduct($provider)
    {
        try {
            $productPayload = [
                ...
                'description' => 'Subscription plans for '.config('app.name', 'Restaurant App Demo'),
                'type' => 'SERVICE',
                'category' => 'SOFTWARE',
