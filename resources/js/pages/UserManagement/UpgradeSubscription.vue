...
import { CreditCard, TrendingUp, ArrowLeft, Check, Star, AlertTriangle, Smartphone } from 'lucide-vue-next';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div v-if="props.availablePlans.length > 0" class="flex gap-4 pt-4">
                ...
                <Button
                    @click="() => { if (selectedPlan) showConfirmModal = true; }"
        ...
        <Dialog v-model:open="showPaymentMethodModal">
            <DialogContent class="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Select your preferred payment method to upgrade your subscription
                    </DialogDescription>
                </DialogHeader>
