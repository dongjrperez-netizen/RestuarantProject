...
const submit = () => {
    form.post(route('regular-employees.store'), {
        onSuccess: () => {
            // Handle success
        }
    });
...
<template>
    <Head title="Add Regular Employee" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Add Regular Employee</h1>
                    <p class="text-muted-foreground">Add a new employee to your restaurant staff</p>
                </div>
            ...
            <Card>
                ...
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <!-- Subscription Error -->
                        <div v-if="form.errors.subscription" class="p-4 bg-red-50 border border-red-200 rounded-md">
                            <p class="text-sm text-red-600">{{ form.errors.subscription }}</p>
                        </div>
